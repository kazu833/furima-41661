class User < ApplicationRecord
  ...
  validates :first_name_kana, presence: true, format: { with: /\A[ァ-ヶ]+\z/, message: 'は全角(カタカナ)で入力してください' }
  validates :last_name_kana, presence: true, format: { with: /\A[ァ-ヶ]+\z/, message: 'は全角(カタカナ)で入力してください' }
